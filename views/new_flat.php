...
<h3>We'll put it on the map for everyone to see.</h3>
    ...
    <div class="form-horizontal" style="width: 80%; margin: 0 auto;">
      ...
      <div class="form-group">
        <label for="daterr">Event Start Date</label>
      	<input id="daterr" type="text" class="form-control"/>
      </div>

      <div class="form-group">
        <label for="sTime">Event Start Time</label>
      	<input id="sTime" class="form-control" value="16:20:00" type="text"/>
      </div>

        <div class="form-group">
        <label for="carrier">Select Event Type</label>
      <select class="form-control" id="category" name="carrier" aria-describedby="categoryHelp">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="number" placeholder="0" id="minNum" name="min" aria-describedby="minHelp">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="number" placeholder="0" id="minNum" name="max" aria-describedby="maxHelp">
